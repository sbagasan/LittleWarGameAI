...
module ZChipAPI{
  ...
  class HiddenMagicStrings{
    ...
    // The name of the type property on a filter object.
    static filterOnlyFinishedPropertyName: string = "onlyFinished";
  }
  ...
  export class Scope{
    ...
    getBuildings(filter: any): Building[]{
      ...
      var onlyFinshed: boolean = filter.onlyFinshed;
      if(type != undefined){
        mappedFilter[HiddenMagicStrings.filterOnlyFinishedPropertyName] = onlyFinshed;
      }
